...
enum Genre:String {case chinese="chinese", greek="greek", italian="italian", mexican="mexican", pizza="pizza", popular="popular", sandwiches="sandwiches", vegetarian="vegetarian" }
